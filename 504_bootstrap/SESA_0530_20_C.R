...
selected_vars <- readRDS("R_objects/selected_vars_SESA.RDS")
...
focal_sp_data <- species_data$SESA
#selected_vars <- selected_vars$SESA
...
all_predicted_SESA <- map_dfr(list(
  "m1_predicted",
  "m2_predicted",
  "m3_predicted",
  "m4_predicted",
...
saveRDS(all_predicted_SESA, "R_objects/predicted_SESA_0530_20_C.RDS")
