...
selected_vars <- readRDS("R_objects/selected_vars_REPH.RDS")
...
focal_sp_data <- species_data$REPH
#selected_vars <- selected_vars$REPH
...
all_predicted_REPH <- map_dfr(list(
  "m1_predicted",
  "m2_predicted",
  "m3_predicted",
  "m4_predicted",
...
saveRDS(all_predicted_REPH, "R_objects/predicted_REPH_0530_20_B.RDS")
