...
selected_vars <- readRDS("R_objects/selected_vars_BBSA.RDS")
...
focal_sp_data <- species_data$BBSA
#selected_vars <- selected_vars$BBSA
...
all_predicted_BBSA <- map_dfr(list(
  "m1_predicted",
  "m2_predicted",
  "m3_predicted",
  "m4_predicted",
...
saveRDS(all_predicted_BBSA, "R_objects/predicted_BBSA_0530_20_B.RDS")
