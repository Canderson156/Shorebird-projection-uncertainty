...
selected_vars <- readRDS("R_objects/selected_vars_BASA.RDS")
...
focal_sp_data <- species_data$BASA
#selected_vars <- selected_vars$BASA
...
all_predicted_BASA <- map_dfr(list(
  "m1_predicted",
  "m2_predicted",
  "m3_predicted",
  "m4_predicted",
...
saveRDS(all_predicted_BASA, "R_objects/predicted_BASA_0530_20_B.RDS")
