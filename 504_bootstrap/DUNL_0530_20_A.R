...
selected_vars <- readRDS("R_objects/selected_vars_DUNL.RDS")
...
focal_sp_data <- species_data$DUNL
#selected_vars <- selected_vars$DUNL
...
all_predicted_DUNL <- map_dfr(list(
  "m1_predicted",
  "m2_predicted",
  "m3_predicted",
  "m4_predicted",
...
saveRDS(all_predicted_DUNL, "R_objects/predicted_DUNL_0530_20_A.RDS")
