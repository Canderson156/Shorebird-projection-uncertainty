...
selected_vars <- readRDS("R_objects/selected_vars_STSA.RDS")
...
focal_sp_data <- species_data$STSA
#selected_vars <- selected_vars$STSA
...
all_predicted_STSA <- map_dfr(list(
  "m1_predicted",
  "m2_predicted",
  "m3_predicted",
  "m4_predicted",
...
saveRDS(all_predicted_STSA, "R_objects/predicted_STSA_0530_20_A.RDS")
