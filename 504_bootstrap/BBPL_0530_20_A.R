...
# Time to run: 1.25 hr per gootstrap
...
selected_vars <- readRDS("R_objects/selected_vars_BBPL.RDS")
...
focal_sp_data <- species_data$BBPL
#selected_vars <- selected_vars$BBPL
...
all_predicted_BBPL <- map_dfr(list(
  "m1_predicted",
  "m2_predicted",
  "m3_predicted",
  "m4_predicted",
...
saveRDS(all_predicted_BBPL, "R_objects/predicted_BBPL_0530_20_A.RDS")
