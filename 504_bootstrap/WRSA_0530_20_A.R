...
selected_vars <- readRDS("R_objects/selected_vars_WRSA.RDS")
...
focal_sp_data <- species_data$WRSA
#selected_vars <- selected_vars$WRSA
...
all_predicted_WRSA <- map_dfr(list(
  "m1_predicted",
  "m2_predicted",
  "m3_predicted",
  "m4_predicted",
...
saveRDS(all_predicted_WRSA, "R_objects/predicted_WRSA_0530_20_A.RDS")
